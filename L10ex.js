...
function setup() {
  ...
  //var url = 'http://openapi.seoul.go.kr:8088/6d736b52546a757335357744e66546c/json/ListAirQualityByDistrictService/1/25/';
  var url = 'https://cors-anywhere.herokuapp.com/http://openapi.seoul.go.kr:8088/6d736b52546a757335357744e66546c/json/ListAirQualityByDistrictService/1/25/';
  loadJSON(url, onAirQ);
...
function draw() {
  ...
  for (i = 0; i < nDist; i++) {
    ...
    if (isNaN(airQdata.row[i].PM10)) {
      ...
      text(airQdata.row[i].MSTSTENAME, airQdata.row[i].PM10*3 + 80, 0);
    }
    pop();
  }
}
